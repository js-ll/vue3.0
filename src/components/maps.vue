<template>
    <div class="calendar-container">
        <div class="year">
                ...
                <span class="fl" style="flex-grow:1" @click="lastYear">«</span>
                <span class="fl" style="flex-grow:1" @click="lastMonth">‹</span>
                <span class="f2" style="flex-grow:2">{{nowDate.year}}年{{nowDate.month+1}}月</span>
               
                <span class="f1" style="flex-grow:1" @click="nextMonth">›</span>
                 <span class="f1" style="flex-grow:1" @click="nextYear">»</span>
...
export default {
    ...
    computed: {
        ...
        lastMonthStartDay () {
          console.log(this.calcLastMonthDays(this.nowDate.year,this.nowDate.month)-(this.startWeek()-1))
